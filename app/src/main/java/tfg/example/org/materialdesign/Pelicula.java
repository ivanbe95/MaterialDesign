...
public class Pelicula {
    ...
    public Pelicula(String posterPath, boolean adult, String overview,
                 String releaseDate, Integer[] genreIds, Integer id,
    ...
    public Integer[] getGenresObject() {return genreIds;}
